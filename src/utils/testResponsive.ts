...
export const rW = (width:number) =>{
  return responsiveWidth(width);
};

export const rH = (width:number) =>{
  return responsiveHeight(width);
};

export const rFS = (width:number) =>{
  return responsiveFontSize(width);
};

export const paddingTopiOS = Platform.OS === 'ios' ? getStatusBarHeight(true) + 20 : 0;
...
// new orientaion change custom hook 
